...
## The Omnidea Covenant License (Self-Governing)
...
## Legal Foundation: AGPL-3.0

**This License incorporates the terms of the [GNU Affero General Public License, version 3.0](https://www.gnu.org/licenses/agpl-3.0.html) (AGPL-3.0) as its legal foundation.**

All provisions of the AGPL-3.0 apply to this work. In particular:

- **Source sharing:** If you modify this work and make it available to users over a network, you must make the complete corresponding source code available under this License.
- **Copyleft:** Derivative works must carry this same License or one compatible with its terms. You may not convert this work into proprietary software.
- **Patent grant:** Contributors grant a royalty-free patent license for their contributions.

The Covenant conditions in this License are **additional binding terms** beyond the AGPL-3.0. They do not weaken, replace, or conflict with the AGPL-3.0.

**Severability between layers:** If any court holds the Covenant conditions unenforceable, the AGPL-3.0 terms remain in full force.

The full text of the AGPL-3.0 is available at: https://www.gnu.org/licenses/agpl-3.0.html
...
- Read, study, audit, and understand this code in its entirety
- Copy, share, and distribute it in any medium or format
- Modify, adapt, extend, and build upon it
- Implement it as infrastructure for communities, cooperatives, or assemblies
- Run it for any purpose -- personal, communal, commercial, educational, or experimental
- Fork it and shape it to the needs of your community

**No fee, registration, or permission is required.**

---

## Binding Condition: Alignment with the Covenant

**All use of Omnidea is subject to one binding condition:**

**You must remain in alignment with the Covenant's Core principles: Dignity, Sovereignty, and Consent.**

This means:
- Your use must uphold the dignity of all persons
- Your use must honor the sovereignty of every person over their identity, their data, and their experience
- Your use must not violate consent -- informed, continuous, and revocable
- Your use must not enable surveillance, subjugation, extraction, or domination
- Your use must not enclose, commodify, or destroy the Commons -- digital or living

Where your use contradicts the Core, you breach this License, and all rights granted herein are immediately and automatically terminated for the violating party.

---

## No Enclosure, No Ownership

**Omnidea cannot be owned, trademarked, or enclosed.**

- No person or entity may claim proprietary control over this system, its protocols, or its data formats
...
This work remains in the Commons, protected by the Covenant.
...
Commonsright 2025-present The Omnidea Contributors

Stewarded under the Omnidea Covenant License -- maximally free,
bound by one condition: alignment with the Covenant's Core and Commons.
